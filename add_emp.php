...
$addData = $database->prepare("insert into Employee(empID,fname,lname,salary)values (:id, :fname, :lname,:salary )");

 $addData->bindParam("fname",$fname);
 $addData->bindParam("lname",$lname);
 $addData->bindParam("id",$id);

 $addData->bindParam("salary",$salary);
...
<div class="container-fluid mb-4">
        ...
        <h3 class="text-center">Insert Employee</h3>
		   <div class="form-group">
                ...
                <input type="text" class="form-control" name="fname" placeholder="Enter frist name">
                </div>
